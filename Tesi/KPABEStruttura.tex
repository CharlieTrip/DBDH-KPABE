...
Nella nostra trattazione useremo sempre strutture d'accesso monotone.\\[1cm]
...
Mediante questo gioco, il vantaggio dell'avversario \evil{A} è definito come $\lvert \mathbb{P}(b = b^\prime) - \frac{1}{2}\rvert$.\\
